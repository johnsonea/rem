...
*add* [--date <date> | --date -<secondsBeforeNow> | --date +<secondsAfterNow>] [(--arriving | --leaving) (<address> | <latitude,longitude>)] [--note <note>] [--priority <integer0-9>] <remindertitle>:: add reminder to the default list
